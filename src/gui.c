...
static gui_screen_handler_t screenHandlers[] = {{&menuHandleInputMain, &menuRenderMain, 0},
                                                ...
                                                {&menuHandleInputElmMenu, &menuRenderElmMenu, 1}};
...
void guiShowConfig()
{
    ...
    const char *deviceNames[] = {_l(_STR_BDM_GAMES), _l(_STR_NET_GAMES), _l(_STR_HDD_GAMES), _l(_STR_APPS), _l(_STR_PSX_GAMES), NULL};
